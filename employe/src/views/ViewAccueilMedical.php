        ...
        <tbody>
            ...
            if (count($tab_patient) > 0) {
                foreach ($tab_patient as $element) {
                    ...
                    echo "<td class='bout_tab'>
                        <button type='button' onclick='window.location.href=\"?url=SuiviMedical&patientId=" .  (isset($element[3]) ? htmlspecialchars($element[3]) : "") . "&nom=" . (isset($element[1]) ? htmlspecialchars($element[1]) : ""). "" . (isset($element[2]) ? htmlspecialchars($element[2]) : "") . "\";'>Compte Rendu</button>
                    </td>";
                    echo "</tr>";
                }
            }
